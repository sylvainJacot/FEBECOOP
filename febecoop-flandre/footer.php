...
<footer>
    ...
    <?
                set_query_var( 'logoName', 'logo_VB_HD.png' ); 
                    ...
                    ?>
                        ...
                        <div class="coordonees-item">
                            ...
                            <div class="coordonees-item-coordonees">
                                <a href="https://www.google.com/maps/dir/?api=1&destination=<?php echo $new_fulladress; ?>&travelmode=driving" target="_blank" rel="noreferrer">
