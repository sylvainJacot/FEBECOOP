        ...
        <div class="agenda-formations-header" id="js-agenda-formations-header">
            ...
            <div class="agenda-formations-container" id="js-agenda-formations-container">
                ...
                <?php if ($count_ev === 0) :?>
                    ...
                    <span class="agenda-formation-empty-texte">Momenteel geen workshops of events. Schrijf je in op onze <a href="http://eepurl.com/dzDMeT" target="_blank">e-nieuwsbrief</a> om op de hoogte te blijven. </span>
                 <?php endif ;?>
