...
<head>
    ...
    <link rel="mask-icon" href="<?php echo get_template_directory_uri(); ?>/ASSETS/IMAGES/FAVICON/safari-pinned-tab.svg" color="#ffdc54">
...
<body <?php body_class(''); ?> class="body-active">
    ...
    <header id="js-header">
        <div class="header-wrapper">
            ...
            <div class="header-second-section-mobile header-second-section-mobile-federal" id="js-header-second-section-mobile">
                <div class="header-second-section-mobile-wrapper header-second-section-mobile-wrapper-federal grid">
                ...
                <?php get_template_part('src/TEMPLATES/MenuLang/menu-lang'); ?>
            </div>
            <div class="header-second-section-laptop">
                <div class="header-second-section-laptop-wrapper">
                    ...
                    <div class="header-second-section-bottom header-second-section-bottom-federal">
                        <?php get_template_part('src/TEMPLATES/Header/header-main-nav'); ?>
                    </div>
