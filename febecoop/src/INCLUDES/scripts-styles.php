...
function febecoop_scripts() {
    ...
    wp_enqueue_script( "load-more-actus", get_template_directory_uri(  ) . "/src/JS/loadmoreposts_actualites.js", array(), rand(100000,200000), true);
    wp_enqueue_script( "load-more-projetsacc", get_template_directory_uri(  ) . "/src/JS/loadmoreposts_projetsaccompagnes.js", array(), rand(100000,200000), true);
