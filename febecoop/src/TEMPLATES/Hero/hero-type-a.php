<section class="hero-section-type-a">
    <picture class="orange-wave-container">
    <source srcset="<?php echo get_template_directory_uri(  );?>/src/ASSETS/IMAGES/HOME/VECTOR/orange-wave-wallonia-desktop.svg" media="(min-width: 1300px)"/>
    <source srcset="<?php echo get_template_directory_uri(  );?>/src/ASSETS/IMAGES/HOME/VECTOR/orange-wave-wallonia-laptop.svg" media="(min-width: 1025px)"/>
