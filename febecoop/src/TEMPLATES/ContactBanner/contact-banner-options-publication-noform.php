<section class="contact-banner-section" id="contact-banner-options-publication-noform">
    ...
    <div class="contact-banner-section-wrapper">
        ...
        <div class="contact-banner-content-wrapper grid">
            <div class="contact-banner-content-text">
                <h2><span><?php the_field('ban-cont-titre', 'options'); ?></span></h2>
                <p><?php the_field('ban-cont-texte', 'options'); ?></p>
            </div>
            <?php
            $link = get_field('ban-cont-bouton','options');
            if ($link) :
                $link_url = $link['url'];
