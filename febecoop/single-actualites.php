...
<section class="other-news-section">
    <div class="slider-wrapper-type-b  other-news-section-wrapper other-news-section-wrapper-mobile grid">
                ...
                <a class="cta-d" href="<?php echo esc_url(home_url('/')); ?>file-actualites" ><span><?php pll_e('Toutes les actualités');?></span></a>
                </div>
                ...
                <a class="cta-b" href="<?php echo esc_url(home_url('/')); ?>file-actualites" ><?php pll_e('Toutes les actualités');?></a>
    </div>
    </div> 
