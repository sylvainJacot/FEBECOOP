...
<section class="notes-pratiques-outils-loop-section">
    <div class="notes-pratiques-outils-loop-wrapper grid">
        ...
        <p class="filter-npoq-header">Filtrer par :</p>
        ...
        <div class="npo-items-wrapper">
            ...
            <?php endif; ?>
            <a style="opacity: 0; transition: opacity 1s;"  href="<?php echo esc_url(home_url('/')); ?>notes-pratiques-outils" class="cta-a"><?php pll_e('Tous les outils et notes pratiques');?></a>
            </div>
        </div>
    </div>
</section>
